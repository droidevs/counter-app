...
object HistoryUseCaseModule {
    ...
    @Provides
    @Singleton
    fun provideGetHistoryUseCase(repository: HistoryRepository, dispatchers: DispatcherProvider): GetHistoryUseCase =
        GetHistoryUseCase(repository, dispatchers)

    @Provides
    @Singleton
    fun provideAddHistoryEventUseCase(recorder: HistoryEventRecorder, dispatchers: DispatcherProvider): AddHistoryEventUseCase =
        AddHistoryEventUseCase(recorder, dispatchers)

    @Provides
    @Singleton
    fun provideClearHistoryUseCase(repository: HistoryRepository, dispatchers: DispatcherProvider): ClearHistoryUseCase =
        ClearHistoryUseCase(repository, dispatchers)
