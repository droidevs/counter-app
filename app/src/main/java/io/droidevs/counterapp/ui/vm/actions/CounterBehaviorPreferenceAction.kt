...
sealed class CounterBehaviorPreferenceAction {
    ...
    data class SetMaximumCounterValue(val value: Int) : CounterBehaviorPreferenceAction()
    data class SetMinimumCounterValue(val value: Int) : CounterBehaviorPreferenceAction()
}
